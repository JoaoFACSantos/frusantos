 ...
 *
 * Colapsa suavemente ao fazer scroll (ver [data-utility-bar] em
 * src/css/main.css e o listener de scroll em src/js/main.js).
 *
 * @package Frusantos
 */
?>
<div class="hidden bg-slate lg:grid" data-utility-bar>
	<div class="overflow-hidden">
		<div class="mx-auto flex max-w-[1440px] items-center justify-between px-[60px] py-[11px] text-[13px] text-slate-200">
