	...
	<div class="grid gap-5 md:grid-cols-3">
		<?php foreach ($frusantos_areas as $i => $area) : ?>
			<a
				...
				class="fade-in-up group overflow-hidden rounded-theme border border-neutral-200 bg-white transition duration-250 hover:-translate-y-1 hover:shadow-soft"
			...
			>
				<div class="relative h-[200px] overflow-hidden">
					<img
						...
						loading="lazy"
					>
					<span class="absolute left-4 top-4 rounded-full bg-surface/90 px-2.5 py-1.5 font-mono text-[11px] tracking-[.1em]">
						<?php echo esc_html(sprintf('%02d', $i + 1)); ?>
					</span>
				</div>
				<div class="p-6">
					<h3 class="mb-2.5 text-[19px] font-bold uppercase tracking-[.03em] text-ink"><?php echo esc_html($area['title']); ?></h3>
